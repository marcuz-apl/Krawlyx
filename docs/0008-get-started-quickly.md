...
Configure batch target URLs, toggle randomized multi-worker session gaps (0.5m–10m), choose between Playtrafi and Scrapy, or define custom structured extraction schemas.
