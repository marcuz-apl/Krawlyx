...
export function AdminEnginesTable() {
  ...
  const restore = useMutation({
    ...
    onSuccess: () => {
      ...
      setSuccessMsg('Default engines (Patroy, Playtrafi, and Scrapy) restored and pooled successfully!');
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            title="Re-creates default Patroy, Playtrafi, and Scrapy engines if missing or unpooled"
          >
