...
export function AdminEnginesTable() {
  ...
  const restore = useMutation({
    ...
    onSuccess: () => {
      ...
      setSuccessMsg('Default engines (Crawl4AI and Scrapy) restored and pooled successfully!');
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            title="Re-creates default Crawl4AI and Scrapy engines if missing or unpooled"
          >
...
function CreateForm({ onDone }: { onDone: () => void }) {
  ...
  const availableTypes = capData?.types?.map((t) => t.type) ?? ['crawl4ai', 'scrapy'];
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <label className="text-xs font-semibold">
          ...
          <input
            ...
            placeholder="e.g. My Custom Crawl4AI"
