    ...
    <div>
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <a
            ...
            download
            className="inline-flex items-center gap-1 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 py-1.5 text-xs font-medium text-slate-700 dark:text-slate-300 shadow-sm hover:bg-slate-50 dark:bg-slate-800/60 transition-colors"
          >
            Export JSON
          </a>
          <button
      ...
      {saveOpen && (
        <div className="mb-5 rounded-xl border border-brand-200 bg-brand-50/60 p-4 space-y-3">
          <h3 className="text-sm font-semibold text-slate-900 dark:text-white">Save Job Dataset to Database</h3>
      ...
      {structuredItems.length > 0 && (
        <div className="mb-4 flex gap-2 border-b border-slate-200 dark:border-slate-800 pb-2">
          <button
      ...
      <div className="mt-4 flex items-center justify-between text-sm text-slate-600 dark:text-slate-400">
        ...
        <div className="flex gap-2">
          <Link
            to={`/jobs/${data.job_id}`}
            className="rounded border border-slate-300 dark:border-slate-700 px-3 py-1 hover:bg-slate-100"
          >
            ← Back to job
          </Link>
          <button
            ...
            className="rounded border border-slate-300 dark:border-slate-700 px-3 py-1 hover:bg-slate-100 disabled:opacity-50"
          >
            ← Prev
          </button>
          <button
